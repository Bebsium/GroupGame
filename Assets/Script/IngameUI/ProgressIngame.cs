...
public class ProgressIngame : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(1))
        {
            ...
            {
                if (hit.collider.gameObject.name == "QueenDoll")
                {
                    int r = 3;
                    icon.GetComponent<Image>().sprite = playerSprites[r];
                    skill.GetComponent<Image>().sprite = skillSprites[r];
                ...
                if (hit.collider.gameObject.name == "CatDoll")
                {
                    int r = 1;
                    icon.GetComponent<Image>().sprite = playerSprites[r];
                    skill.GetComponent<Image>().sprite = skillSprites[r];
                ...
                if (hit.collider.gameObject.name == "HatDoll")
                {
                    int r = 0;
                    icon.GetComponent<Image>().sprite = playerSprites[r];
                    skill.GetComponent<Image>().sprite = skillSprites[r];
    ...
    void Init()
    {
        ...
        timer = new float[6] { 4f, 4f, 4f, 4f, 4f, 4f};
    }
    ...
    void EndCheck()
    {
        ...
        {
            angle += 0.1f;
            hourHand.transform.rotation = Quaternion.Euler(0, 0, -angle);
        }
        else
        {
